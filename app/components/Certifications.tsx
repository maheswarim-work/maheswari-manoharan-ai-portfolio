          ...
          {certifications.map((cert, index) => (
            <div key={index} className="p-6 rounded-lg transition-all hover:shadow-lg" style={{
              ...
              <div className="flex items-start mb-4">
                <Award className="mr-3 flex-shrink-0" size={24} style={{color: '#f472b6'}} />
                <div>
                  <h3 className="text-lg font-semibold" style={{color: '#ec4899'}}>{cert.name}</h3>
              ...
              <div className="space-y-2 text-sm" style={{color: '#1E293B'}}>
                <div className="flex items-center">
                  <Calendar size={14} className="mr-2" style={{color: '#f472b6'}} />
                  <span>Issued: {cert.issued}</span>
                </div>
                <div className="flex items-center">
                  <Clock size={14} className="mr-2" style={{color: '#f472b6'}} />
