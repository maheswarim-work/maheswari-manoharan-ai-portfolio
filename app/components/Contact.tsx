          ...
          <div className="card">
            <div className="text-center">
              ...
              <a
                ...
                download
                className="inline-flex items-center justify-center space-x-2 px-8 py-4 rounded-lg font-semibold transition-all mb-10 hover:-translate-y-0.5 hover:shadow-lg"
                style={{
